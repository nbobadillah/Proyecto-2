...
public class OperadorTest {
    ...
    public void testGetTipo() {
        assertEquals("Operador", operador.getTipo());
    }

    @Test
    
    public void testMostrarPiezasSubastar(){
        ArrayList<Pieza> subastar = operador.mostrarPiezasASubastar(galeria);
        assertEquals(6, subastar.size() );
    }

    @Test
    
    public void testRegistrarOfertaValid() throws DineroOfrecidoInsuficienteException, DineroInsuficienteException{
        operador.registrarOferta(4000, pintura, comprador, subasta);
    }

    @Test
    
    public void testRegistrarOfertaDineroOfrecidoInsuficiente() throws DineroOfrecidoInsuficienteException, DineroInsuficienteException{
        assertThrows(DineroOfrecidoInsuficienteException.class, () -> operador.registrarOferta(400, pintura, comprador, subasta));
    }

    @Test 
    
    public void testRegistrarOfertaDineroInsuficiente() throws DineroOfrecidoInsuficienteException, DineroInsuficienteException{
        operador.registrarOferta(4000, pintura, comprador, subasta);
        assertThrows(DineroInsuficienteException.class, () -> operador.registrarOferta(1000, pintura, comprador2, subasta));
    }
